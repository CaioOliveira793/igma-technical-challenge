...
const { compilerOptions } = JSON.parse(readFileSync('./tsconfig.json', { encoding: 'utf8' }));
...
const config: Config = {
	...
	transform: {
		'\\.ts$': ['ts-jest', { tsconfig: compilerOptions, useESM: true }],
	},

	// File extensions that will be treated as native ESM
